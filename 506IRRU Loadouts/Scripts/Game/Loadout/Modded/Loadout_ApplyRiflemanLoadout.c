sealed class Loadout_ApplyRiflemanLoadout {
	static const string RIFLEMAN_LOADOUT_NAME = "RiflemanLoadout";

	static bool ApplyRiflemanLoadout(IEntity characterEntity)
	{
		return ApplyLoadoutByName(characterEntity, RIFLEMAN_LOADOUT_NAME);
	}
